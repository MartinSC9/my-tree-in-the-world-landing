...
const Navbar = () => {
  ...
  return (
    <>
      <nav
        className="bg-white/95 dark:bg-gray-900/95 backdrop-blur-md border-b border-green-200 dark:border-gray-700 sticky top-0 z-[1000] shadow-sm"
        role="navigation"
                  ...
                  <AnimatePresence>
                    {isProgramsDropdownOpen && (
                      <motion.div
                        ...
                        className="absolute left-0 mt-2 w-64 bg-white dark:bg-gray-800 rounded-xl shadow-xl border border-gray-200 dark:border-gray-700 py-2 z-50"
                      >
