...
import { TreePine, Globe, Users, Award, Leaf, Building2, Calculator, TrendingUp, CheckCircle, Mail } from 'lucide-react';
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              <Card className="bg-white shadow-lg border-green-200">
                <CardHeader className="bg-gradient-to-r from-green-500 to-emerald-600 text-white p-4">
                  ...
                  <p className="text-green-100 text-xs mt-1">Completá el formulario para obtener una estimación mensual</p>
                </CardHeader>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-3 justify-center">
              <Button asChild size="lg" className="bg-white hover:bg-gray-50 text-green-600 border-2 border-white shadow-lg transition-all duration-300 hover:scale-105">
                <Link to="/contacto">
                  <Mail className="h-4 w-4 mr-2" />
