      ...
      >
        <div className="bg-white rounded-2xl shadow-lg p-8 md:p-12 space-y-8">
          ...
          <section>
            ...
            <h3 className="text-lg font-semibold text-gray-700 mb-2">2.1 Información proporcionada por usted:</h3>
            ...
            <h3 className="text-lg font-semibold text-gray-700 mb-2">2.2 Información recopilada automáticamente:</h3>
          ...
          <section>
            <h2 className="text-2xl font-bold text-gray-800 mb-4">5. Cookies y Tecnologías de Seguimiento</h2>
            <p className="text-gray-600 leading-relaxed mb-4">
          ...
          <section>
            <h2 className="text-2xl font-bold text-gray-800 mb-4">6. Seguridad de los Datos</h2>
            <p className="text-gray-600 leading-relaxed">
          ...
          <section>
            <h2 className="text-2xl font-bold text-gray-800 mb-4">7. Sus Derechos</h2>
            <p className="text-gray-600 leading-relaxed mb-4">
          ...
          <section>
            <h2 className="text-2xl font-bold text-gray-800 mb-4">8. Retención de Datos</h2>
            <p className="text-gray-600 leading-relaxed">
          ...
          <section>
            <h2 className="text-2xl font-bold text-gray-800 mb-4">9. Menores de Edad</h2>
            <p className="text-gray-600 leading-relaxed">
          ...
          <section>
            <h2 className="text-2xl font-bold text-gray-800 mb-4">10. Transferencias Internacionales</h2>
            <p className="text-gray-600 leading-relaxed">
          ...
          <section>
            <h2 className="text-2xl font-bold text-gray-800 mb-4">11. Cambios en esta Política</h2>
            <p className="text-gray-600 leading-relaxed">
          ...
          <section>
            <h2 className="text-2xl font-bold text-gray-800 mb-4">12. Contacto</h2>
            <p className="text-gray-600 leading-relaxed">
