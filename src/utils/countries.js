...
export const getRandomCoordinates = (country) => {
  const countryCoordinates = {
    ...
    'Brasil': { lat: -14.2350, lng: -51.9253, radius: 15 },
    'Chile': { lat: -35.6751, lng: -71.5430, radius: 8 },
